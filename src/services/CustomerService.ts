...
class CustomerService {
  ...
  public async findAllMeasuresByCustomer(customerCode: string): Promise<ServiceResponse<ICustomerResponse | ServiceResponseErrorMessage>> {
    const customer = await this.customerModel.findAllMeasuresByCustomer(customerCode);
